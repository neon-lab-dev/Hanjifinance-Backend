...
router.put("/update-profile", multer_config_1.multerUpload.single("file"), (0, auth_1.default)(auth_constants_1.UserRole.user, auth_constants_1.UserRole.admin, auth_constants_1.UserRole.moderator), users_controller_1.UserControllers.updateProfile);
