...
router.post("/raise-query", (0, auth_1.default)(auth_constants_1.UserRole.user, auth_constants_1.UserRole.admin, auth_constants_1.UserRole.moderator), helpdesk_controller_1.HelpDeskControllers.raiseQuery);
