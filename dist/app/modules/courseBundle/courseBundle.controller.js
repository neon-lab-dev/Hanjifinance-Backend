...
const addCourseBundle = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield courseBundle_service_1.CourseBundleService.addCourseBundle(req.body);
...
const updateCourseBundle = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { bundleId } = req.params;
    const result = yield courseBundle_service_1.CourseBundleService.updateCourseBundle(bundleId, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
